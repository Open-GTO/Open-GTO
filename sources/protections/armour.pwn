...
stock REDEF_SetPlayerArmour(playerid, Float:armour)
{
...
stock REDEF_GetPlayerArmour(playerid, &Float:armour)
{
...
pt_armour_Sync(playerid)
{
	...
	if (clientarmour < serverarmour) {
		...
		Admin_SendProtectReport(playerid, "PROTECTION_ARMOUR", clientarmour, serverarmour);
