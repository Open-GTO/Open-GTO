...
stock pt_chat_OnGameModeInit()
{
	...
	Log_Init("protections", "ChatGuard(by MX_Master) module init.");
}
...
stock pt_chat_OnPlayerText ( playerid, text[] )
{
    ...
    {
        Lang_SendText(playerid, "PROTECTION_CHAT_NICK_WITH_IP_OR_DOMAIN");
        return 0;
    }
    ...
    {
        Lang_SendText(playerid, "PROTECTION_CHAT_COMMAND_DETECTED");
        return 0;
    }
    ...
    {
        Lang_SendText(playerid, "PROTECTION_CHAT_CAPSLOCK_ON");
        return 0;
    }
    ...
    {
        Lang_SendText(playerid, "PROTECTION_CHAT_IP_IS_FORBIDDEN");
        return 0;
    }
    ...
    {
        Lang_SendText(playerid, "PROTECTION_CHAT_DOMAIN_IS_FORBIDDEN");
        return 0;
    }
    ...
    {
        Lang_SendText(playerid, "PROTECTION_CHAT_STOP_FLOOD");
        return 0;
    }
    ...
    {
        Lang_SendText(playerid, "PROTECTION_CHAT_SIMILAR_MESSAGE");
        return 0;
    }
