/*
	...
	ќписание: функции дл€ работы с оружием у игрока
	јвтор: Iain Gilbert, ZiGGi
...
stock REDEF_GivePlayerWeapon(playerid, weaponid, ammo, bool:allowcheck = false)
{
	...
	if (!IsWeaponHandToHand(weaponid)) {
		// если оружи€ разные, то обнул€ем патроны
...
// парсит строку, устанавлива€ нужные значени€
...
// возвращает строку дл€ сохранени€ оружи€
...
// парсит строку, устанавлива€ нужные значени€ дл€ стартового оружи€
...
// возвращает строку дл€ сохранени€ стартового оружи€
